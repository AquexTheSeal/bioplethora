...
public class FrostbiteMetalArrowEntity extends AbstractArrowEntity {

    /*private double baseDamage = 12.0D;*/
    private int duration = 200;

    public FrostbiteMetalArrowEntity(EntityType<? extends FrostbiteMetalArrowEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public FrostbiteMetalArrowEntity(World worldIn, LivingEntity shooter) {
        super(BPEntities.BELLOPHITE_ARROW.get(), shooter, worldIn);
    }

    public FrostbiteMetalArrowEntity(World worldIn, double x, double y, double z) {
