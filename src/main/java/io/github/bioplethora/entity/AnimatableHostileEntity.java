...
public abstract class AnimatableHostileEntity extends MonsterEntity implements IAnimatable {
     ...
     * @param worldIn
     */
    public AnimatableHostileEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
