...
public class BPConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> BASALT_SPELEOTHERM_CONFIG = BPFeatures.PENDENT_BLOCKS.get()
            .configured(new PendentBlocksFeatureConfig.Builder()
                    .setTopBlock(Blocks.BASALT).setMiddleBlock(BPBlocks.BASALT_SPELEOTHERM_PLANT.get())
                    .setFruitedBlock(BPBlocks.FIERY_BASALT_SPELEOTHERM.get()).setEndBlock(BPBlocks.BASALT_SPELEOTHERM.get().defaultBlockState().setValue(AbstractTopPlantBlock.AGE, 23))
    ...
    public static final ConfiguredFeature<?, ?> THONTUS_THISTLE_CONFIG = BPFeatures.PENDENT_BLOCKS.get()
            .configured(new PendentBlocksFeatureConfig.Builder()
                    .setTopBlock(Blocks.NETHERRACK).setMiddleBlock(BPBlocks.THONTUS_THISTLE_PLANT.get())
                    .setFruitedBlock(BPBlocks.BERRIED_THONTUS_THISTLE.get()).setEndBlock(BPBlocks.THONTUS_THISTLE.get().defaultBlockState().setValue(AbstractTopPlantBlock.AGE, 23))
    ...
    public static final ConfiguredFeature<?, ?> CERISE_IVY_CONFIG = BPFeatures.PENDENT_BLOCKS.get()
            .configured(new PendentBlocksFeatureConfig.Builder()
                    .setTopBlock(Blocks.NETHER_WART_BLOCK).setMiddleBlock(BPBlocks.CERISE_IVY_PLANT.get())
                    .setFruitedBlock(BPBlocks.SEEDED_CERISE_IVY.get()).setEndBlock(BPBlocks.CERISE_IVY.get().defaultBlockState().setValue(AbstractTopPlantBlock.AGE, 23))
    ...
    public static final ConfiguredFeature<?, ?> SOUL_ETERN_CONFIG = BPFeatures.PENDENT_BLOCKS.get()
            .configured(new PendentBlocksFeatureConfig.Builder()
                    .setTopBlock(Blocks.SOUL_SOIL).setMiddleBlock(BPBlocks.SOUL_ETERN_PLANT.get())
                    .setFruitedBlock(BPBlocks.FLOURISHED_SOUL_ETERN.get()).setEndBlock(BPBlocks.SOUL_ETERN.get().defaultBlockState().setValue(AbstractTopPlantBlock.AGE, 23))
                    .setWhitelist(ImmutableList.of(Blocks.SOUL_SOIL, Blocks.SOUL_SAND, Blocks.NETHERRACK, Blocks.BLACKSTONE))
                    .setMinLength(2)
                    .setMaxLength(10)
                    .build())
            .range(132).squared().count(125);
