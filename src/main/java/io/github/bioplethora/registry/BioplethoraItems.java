...
public class BioplethoraItems {
    ...
    public static final RegistryObject<Item> CREPHOXL_HAMMER = ITEMS.register("crephoxl_hammer", () -> new CrephoxlHammerItem(ItemTier.NETHERITE, 12-5, -3.30f,
            new Item.Properties().rarity(CustomRarityTypes.GODLY).durability(4508).tab(BioplethoraItemGroup.BioplethoraItemItemGroup)));
    public static final RegistryObject<Item> BELLOPHGOLEM_SHIELD = ITEMS.register("bellophgolem_shield", () -> new BellophgolemShieldItem(new Item.Properties().rarity(CustomRarityTypes.LEGENDARY).durability(5000).tab(BioplethoraItemGroup.BioplethoraItemItemGroup)));
