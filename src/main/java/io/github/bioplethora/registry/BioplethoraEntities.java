...
public class BioplethoraEntities {
    ...
    //Reptilia
    public static final RegistryObject<EntityType<NandbriEntity>> NANDBRI = ENTITIES.register("nandbri", () -> EntityType.Builder.of(NandbriEntity::new, EntityClassification.MONSTER).sized(0.6f, 0.8f).build(new ResourceLocation(Bioplethora.MOD_ID, "nandbri").toString()));
}
