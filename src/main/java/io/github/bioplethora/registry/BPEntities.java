...
public class BPEntities {
    ...
    public static final RegistryObject<EntityType<FrostbiteGolemEntity>> FROSTBITE_GOLEM = ENTITIES.register("frostbite_golem", () -> EntityType.Builder.of(FrostbiteGolemEntity::new, EntityClassification.MONSTER).sized(3.5f, 4.75f).build(new ResourceLocation(Bioplethora.MOD_ID, "frostbite_golem").toString()));
    public static final RegistryObject<EntityType<ShachathEntity>> SHACHATH = ENTITIES.register("shachath", () -> EntityType.Builder.of(ShachathEntity::new, EntityClassification.MONSTER).sized(0.6f, 1.8f).build(new ResourceLocation(Bioplethora.MOD_ID, "shachath").toString()));
    ...
    //Projectiles
    public static final RegistryObject<EntityType<FrostbiteMetalClusterEntity>> BELLOPHITE_CLUSTER = ENTITIES.register("frostbite_metal_cluster", () -> EntityType.Builder.<FrostbiteMetalClusterEntity>of(FrostbiteMetalClusterEntity::new, EntityClassification.MISC).sized(2.0F, 2.0F).clientTrackingRange(4)
            .build(new ResourceLocation(Bioplethora.MOD_ID, "frostbite_metal_cluster").toString()));
    public static final RegistryObject<EntityType<FrostbiteMetalArrowEntity>> BELLOPHITE_ARROW = ENTITIES.register("frostbite_metal_arrow", () -> EntityType.Builder.<FrostbiteMetalArrowEntity>of(FrostbiteMetalArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).clientTrackingRange(4)
    ...
    public static final RegistryObject<EntityType<FrostbiteMetalShieldWaveEntity>> BELLOPHITE_SHIELD_WAVE = ENTITIES.register("frostbite_metal_shield_wave", () -> EntityType.Builder.of(FrostbiteMetalShieldWaveEntity::new, EntityClassification.MISC).clientTrackingRange(4)
