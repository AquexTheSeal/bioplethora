...
public class BPEntities {
    ...
    public static final RegistryObject<EntityType<FrostbiteGolemEntity>> FROSTBITE_GOLEM = ENTITIES.register("frostbite_golem", () -> EntityType.Builder.of(FrostbiteGolemEntity::new, EntityClassification.MONSTER).sized(2.8f, 4.2f).build(new ResourceLocation(Bioplethora.MOD_ID, "frostbite_golem").toString()));
