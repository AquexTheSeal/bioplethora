...
public class BPEntities {
    ...
    public static final RegistryObject<EntityType<OnofishEntity>> ONOFISH = ENTITIES.register("onofish", () -> EntityType.Builder.of(OnofishEntity::new, EntityClassification.WATER_CREATURE).sized(0.75f, 0.85f).build(new ResourceLocation(Bioplethora.MOD_ID, "onofish").toString()));
