...
public class HeliobladeEntityGlowLayer extends GeoLayerRenderer<HeliobladeEntity> {

    private static final ResourceLocation GLOW = new ResourceLocation(Bioplethora.MOD_ID, "textures/entity/layers/helioblade_glow_layer.png");
    private static final ResourceLocation MODEL = new ResourceLocation(Bioplethora.MOD_ID, "geo/helioblade.geo.json");

    public HeliobladeEntityGlowLayer(IGeoRenderer<HeliobladeEntity> entityRendererIn) {
