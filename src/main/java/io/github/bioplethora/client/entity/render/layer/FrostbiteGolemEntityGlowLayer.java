...
public class FrostbiteGolemEntityGlowLayer extends GeoLayerRenderer<FrostbiteGolemEntity> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, FrostbiteGolemEntity entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
