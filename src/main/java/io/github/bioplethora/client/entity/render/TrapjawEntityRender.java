...
public class TrapjawEntityRender extends GeoEntityRenderer<TrapjawEntity> {
    ...
    public TrapjawEntityRender(EntityRendererManager renderManager) {
    ...
    @Override
    public RenderType getRenderType(TrapjawEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
