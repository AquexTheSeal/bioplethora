...
public class NandbriEntityRender extends GeoEntityRenderer<NandbriEntity> {
    ...
    @Override
    public void renderEarly(NandbriEntity animatable, MatrixStack stackIn, float ticks, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
    ...
    @Override
    public RenderType getRenderType(NandbriEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
    ...
    @Override
    protected float getDeathMaxRotation(NandbriEntity entity) {
        return 0.0F;
    }
}
