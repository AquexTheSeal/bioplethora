...
public class FleignariteSwordItem extends SwordItem {

    public FleignariteSwordItem(IItemTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
