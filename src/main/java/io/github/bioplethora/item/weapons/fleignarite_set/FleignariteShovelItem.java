...
public class FleignariteShovelItem extends ShovelItem {

    public FleignariteShovelItem(IItemTier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
