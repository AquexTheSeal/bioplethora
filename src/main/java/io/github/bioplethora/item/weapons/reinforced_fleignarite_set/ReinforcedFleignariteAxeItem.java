...
public class ReinforcedFleignariteAxeItem extends AxeItem {

    public ReinforcedFleignariteAxeItem(IItemTier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
