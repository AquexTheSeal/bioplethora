...
public class ReinforcedFleignariteSwordItem extends SwordItem {

    public ReinforcedFleignariteSwordItem(IItemTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
