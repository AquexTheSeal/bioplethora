...
public class ReinforcedFleignaritePickaxeItem extends PickaxeItem {

    public ReinforcedFleignaritePickaxeItem(IItemTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
