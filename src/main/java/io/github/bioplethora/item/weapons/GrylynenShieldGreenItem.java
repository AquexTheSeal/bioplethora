...
public class GrylynenShieldGreenItem extends GrylynenShieldBaseItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("item.bioplethora.green_grylynen_shield.green_crystal_energy.skill").withStyle(ItemSettings.SKILL_NAME_COLOR));
        if (Screen.hasShiftDown() || Screen.hasControlDown()) {
            tooltip.add(new TranslationTextComponent("item.bioplethora.green_grylynen_shield.green_crystal_energy.desc").withStyle(ItemSettings.SKILL_DESC_COLOR));
        }
    }
}
