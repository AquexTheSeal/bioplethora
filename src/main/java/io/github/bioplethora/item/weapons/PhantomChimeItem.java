...
public class PhantomChimeItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("item.bioplethora.phantom_chime.flapping_up.skill").withStyle(BPItemSettings.SKILL_NAME_COLOR));
        if (Screen.hasShiftDown() || Screen.hasControlDown()) {
            tooltip.add(new TranslationTextComponent("item.bioplethora.phantom_chime.flapping_up.desc").withStyle(BPItemSettings.SKILL_DESC_COLOR));
        }
    }
}
