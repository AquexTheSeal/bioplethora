...
public class FleignaritePickaxeItem extends PickaxeItem {

    public FleignaritePickaxeItem(IItemTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
